...
#include <sstream>           // String stream for string manipulations
...
// ============================================================================
// MESSAGE BOARD FILE PERSISTENCE
// ============================================================================
...
MessageBoard globalMessageBoard;
bool running = true;
...
void handleClient(int clientSocket) {
    ...
    // When receiving a POST command:
    // globalMessageBoard.addMessage(author, content);
